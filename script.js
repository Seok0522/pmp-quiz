document.addEventListener('DOMContentLoaded', () => {
    ...
    async function getNotesFileId() {
        // ... (Implementation unchanged, ensure it's inside DOMContentLoaded)
    }

    // ... (All other helper functions like updateNotesOnDrive, saveIncorrectAnswer, etc. must be inside DOMContentLoaded)
